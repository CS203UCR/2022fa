...
styles = "h1 {font-size: 40px;} h2 {font-size: 30px;} p {font-size: 24px;} div.prompt, code, output, prompt, kbd, pre, samp {font-family: 'SF Mono', 'Courier New', Courier, monospace, sans-serif !important;font-size: 24px !important;}"
...
def display_df_mono(df):
    df2 = df.style.set_properties(**{'background-color': 'grey','font-family': 'SF Mono','font-size': '20pt',})
    display(df2)
    return
